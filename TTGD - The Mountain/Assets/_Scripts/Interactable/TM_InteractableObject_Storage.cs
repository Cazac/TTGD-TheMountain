...
public class TM_InteractableObject_Storage : MonoBehaviour, TM_InteractableObject_Base
{
    ////////////////////////////////
    ...
    public void OnStartHover()
    {
        ...
        TM_InteractionController.Instance.InteractionText_Set("Press (F) to access The Storage");
    ...
    public void OnInteractTap()
    {
        ...
        if (TM_PlayerMenuController_UI.Instance.gameState_IsMenu && TM_PlayerMenuController_UI.Instance.Storage_Panel.activeSelf == true)
        {
            //Close UI
            TM_HomeMenuController_Storage.Instance.StorageMenu_CloseUI();
        }
        else if (TM_PlayerMenuController_UI.Instance.gameState_IsMenu && TM_PlayerMenuController_UI.Instance.Storage_Panel.activeSelf == false)
        {
            return;
        }
        else
        {
            //Open UI
            TM_HomeMenuController_Storage.Instance.StorageMenu_OpenUI();
        }
    }
