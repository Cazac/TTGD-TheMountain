...
public class TM_Cycle
{
    ...
    public Color cycleColor; //Panel's Current Cycle Color
    public string cycleName; //Panel's Current Cycle Name
    ///////////////////////////////////////////////////////
    public static TM_CycleShuffleBag shuffleBag; //Single instance of the shuffle bag that is shared amongst all TM_Cycle Objects
    ...
    public void SetRandomCycle()//Sets a random cycle using the Shuffle Bag technique
    {
