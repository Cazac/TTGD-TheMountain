...
public class TM_NewDungeonGenerator : MonoBehaviour
{
    ////////////////////////////////

    public static TM_NewDungeonGenerator Instance;
    ...
    public TM_NewRoom startingRoom_Room;
    ...
    public IEnumerator GenerateDungeon()
    {
        ...
        while ((currentRoomAmount <= maxRoomAmount) && (avalibleDoorways_List.Count > 0))
        {
            ...
            //Get the Room Script
            TM_NewRoom spawnedRoom_Room = spawnedRoom_GO.GetComponent<TM_NewRoom>();
    ...
    private void AddDoorsFromRoom(TM_NewRoom newRoom_Room)
    {
    ...
    private void Room_Setup()
    {
        ...
        {
            TM_NewRoom currentRoom_Room = roomGO.GetComponent<TM_NewRoom>();
    ...
    public void Room_SetLootNodes(TM_NewRoom room)
    {
    ...
    public void Room_SetResourceNodes(TM_NewRoom room)
    {

    }

    public void Room_SetEnemyNodes(TM_NewRoom room)
    {
    ...
    public TM_DoorwayTab GetRandomDoorway_Room(TM_NewRoom room)
    {
